...
void GameOverScreenProcess(struct Main *main)
{
    ...
    case 0:
        ...
        DmaCopy16(3, GFX_IMG_game_over_doors, VRAM+0x1400, 0x2E0);
        DmaCopy16(3, GFX_PALETTE_game_over_doors, PLTT+0x20, 0x20);
        DmaCopy16(3, GFX_IMG_game_over_text, VRAM+0x13400, 0x1000);
        DmaCopy16(3, GFX_PALETTE_game_over_text, PLTT+0x2A0, 0x20);
        for(i = 0; i < 0x400; i++)
        {
            gBG2MapBuffer[i] = 0;
        }

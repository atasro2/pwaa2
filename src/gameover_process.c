...
void GameOverScreenProcess(struct Main *main)
{
    ...
    case 0:
        ...
        DmaCopy16(3, gUnknown_08142DFC, VRAM+0x1400, 0x2E0);
        DmaCopy16(3, gUnknown_0814DEA0, PLTT+0x20, 0x20);
        DmaCopy16(3, gUnknown_081448DC, VRAM+0x13400, 0x1000);
        DmaCopy16(3, gUnknown_0814DF00, PLTT+0x2A0, 0x20);
        for(i = 0; i < 0x400; i++)
        {
            gBG2MapBuffer[i] = 0;
        }

    ...
    #define OAM_IDX_INVESTIGATION_ACTIONS 52
    #define OAM_IDX_INVESTIGATION_ACTION_EXAMINE 52+0
    #define OAM_IDX_INVESTIGATION_ACTION_MOVE 52+1
    #define OAM_IDX_INVESTIGATION_ACTION_TALK 52+2
    #define OAM_IDX_INVESTIGATION_ACTION_PRESENT 52+3
    #define OAM_COUNT_INVESTIGATION_ACTIONS 4

    #define OAM_IDX_ITESTIMONY_INDICATOR 57

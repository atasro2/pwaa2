...
#define OAM_IDX_LR_ARROW_LEFT OAM_IDX_LR_ARROW
#define OAM_IDX_LR_ARROW_RIGHT OAM_IDX_LR_ARROW+1
...
#define OAM_IDX_TAKE_THAT_EVIDENCE_THROW OAM_IDX_GENERAL_USE_1
...
#define OAM_IDX_TEXT_FULLSCREEN_POINTER OAM_IDX_GENERAL_2

...
struct Main
{
    ...
    /* +0x01E */ u16 testimonyLastSection; // unity: Bk_end_mess
    ...
    /* +0x030 */ u16 loadedBG; // unity AA4: Bg256_load_no? only ever set to != 0x7F in CopyBGDataToVram to the same value as currentBG
    /* +0x032 */ s16 previousBG; // unity AA4: Bg256_no_old? probably wrong
    /* +0x034 */ s8 currentBgStripe; // maybe Bg256_rno_0?
    /* +0x035 */ u8 disableDetentionCenterMask;
    ...
    u8 filler2B1[0x2B4 - 0x2B1]; // no OK without this
    /* +0x2B4 */ u8 signalDetectorState;
    u8 filler2B5[0x2B8 - 0x2B5]; // no OK without this
    /* +0x2B8 */ u16 currentlyPlayingSfx;
    /* +0x2BA */ u16 currentlyPlayingLoopedSfx;
    /* +0x2BC */ u8 currentNametagId;
    /* +0x2BD */ u8 currentNametagSide;
    /* +0x2BE */ u8 courtBenchSpritesTypeFlag;
    u8 unused2BF;
}; /* size 0x2C0 */

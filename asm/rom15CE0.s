...
_0801627E:
	...
	bl DestroyAnimation
_08016288:
	ldr r0, _080162A0 @ =gUnknown_03006050
	movs r1, #6
	ldrsh r2, [r0, r1]
	mov r8, r0
	cmp r2, #1
	...
	b _080163B6
	.align 2, 0
_080162A0: .4byte gUnknown_03006050
_080162A4:
	cmp r2, #2
	beq _08016344
	b _080163B6
...
_080162BC:
	...
	cmp r6, #0xff
	ble _080162BC
	ldr r1, _08016340 @ =gUnknown_03006050
	movs r2, #0
	movs r0, #0xff
	strh r0, [r1, #0xa]
	strh r2, [r1, #0xc]
...
_0801632C:
	...
	bl _08016C6A
	.align 2, 0
_0801633C: .4byte gMain
_08016340: .4byte gUnknown_03006050
_08016344:
	movs r6, #0x21
	movs r7, #0x1f
_08016348:
...
_080163B6:
	...
	b _0801648C
_080163C2:
	ldr r4, _080163D8 @ =gUnknown_03006050
	movs r3, #6
	ldrsh r0, [r4, r3]
	cmp r0, #1
	beq _0801641E
	...
	bl _08016C6A
	.align 2, 0
_080163D8: .4byte gUnknown_03006050
_080163DC:
	cmp r0, #2
	beq _0801645C
	cmp r0, #3
...
_080163E8:
	...
	strh r0, [r4, #6]
_0801641E:
	ldr r4, _08016458 @ =gUnknown_03006050+0x10
	adds r0, r4, #0
	bl sub_8015DBC
	movs r0, #0xc6
	lsls r0, r0, #1
...
_0801644A:
	...
	b _0801691A
	.align 2, 0
_08016458: .4byte gUnknown_03006050+0x10
_0801645C:
	movs r1, #0
	ldrsh r0, [r4, r1]
	adds r0, #0x7f
	...
	strh r0, [r4, #6]
_08016472:
	ldr r2, _08016494 @ =gUnknown_03006050
	ldrh r0, [r2, #0xa]
	adds r1, r0, #1
	strh r1, [r2, #0xa]
	lsls r0, r0, #0x10
...
_0801648C:
	...
	bl _08016C6A
	.align 2, 0
_08016494: .4byte gUnknown_03006050
_08016498:
	ldr r0, _080164B4 @ =gUnknown_03006050
	movs r3, #6
	ldrsh r2, [r0, r3]
	mov r8, r0
	cmp r2, #5
...
_080164A8:
	lsls r0, r2, #2
	ldr r1, _080164B8 @ =_080164BC
	adds r0, r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080164B4: .4byte gUnknown_03006050
_080164B8: .4byte _080164BC
_080164BC: @ jump table
	.4byte _080164D4 @ case 0
	.4byte _08016544 @ case 1
	.4byte _08016610 @ case 2
	.4byte _08016640 @ case 3
	.4byte _08016662 @ case 4
	.4byte _08016996 @ case 5
_080164D4:
	movs r6, #0
	mov r4, r8
	movs r1, #0
	...
	cmp r6, r0
	bge _08016536
	ldr r5, _080165A0 @ =gUnknown_0811246C
_080164E2:
	movs r2, #0
	ldrsh r1, [r4, r2]
	subs r1, #1
	...
	blt _080164E2
_08016536:
	ldr r0, _080165A8 @ =gUnknown_03006050
	movs r1, #0
	strh r1, [r0, #0xa]
	ldrh r1, [r0, #6]
	adds r1, #1
...
_08016584:
	...
	b _080165BC
	.align 2, 0
_080165A0: .4byte gUnknown_0811246C
_080165A4: .4byte 0xDFFFFFFF
_080165A8: .4byte gUnknown_03006050
_080165AC:
	ldr r0, [r4]
	bl sub_8014124
	ldr r2, [r4]
	ldr r0, [r2]
	ldr r1, _08016608 @ =0xFFFFFEFF
	ands r0, r1
	str r0, [r2]
_080165BC:
	adds r6, #1
	ldr r0, _0801660C @ =gUnknown_03006050
	movs r4, #0
	ldrsh r1, [r0, r4]
	mov r8, r0
	cmp r6, r1
...
_080165FA:
	...
	b _08016C6A
	.align 2, 0
_08016608: .4byte 0xFFFFFEFF
_0801660C: .4byte gUnknown_03006050
_08016610:
	ldr r2, _0801663C @ =gMain
	adds r3, r2, #0
	adds r3, #0xdc
	ldr r0, [r3]
	movs r1, #1
...
_08016676:
	...
	b _08016A86
_0801667C:
	ldr r5, _08016690 @ =gUnknown_03006050
	movs r4, #6
	ldrsh r7, [r5, r4]
	cmp r7, #1
	beq _0801672C
	...
	b _08016C6A
	.align 2, 0
_08016690: .4byte gUnknown_03006050
_08016694:
	cmp r7, #2
	beq _08016754
	b _08016C6A
_0801669A:
	...
	lsls r3, r1, #1
	adds r6, r3, #1
	ldr r2, _08016724 @ =gUnknown_0811246C
	lsls r1, r3, #1
	adds r1, r1, r2
	movs r3, #0
	ldrsh r1, [r1, r3]
	...
	b _0801674C
	.align 2, 0
_08016724: .4byte gUnknown_0811246C
_08016728: .4byte gMain
_0801672C:
	ldrh r0, [r5, #0xa]
	adds r1, r0, #1
	strh r1, [r5, #0xa]
...
_08016764:
	...
	b _08016C6A
_0801678A:
	ldr r0, _080167A4 @ =gUnknown_03006050
	movs r4, #6
	ldrsh r3, [r0, r4]
	mov r8, r0
	cmp r3, #9
...
_08016798:
	lsls r0, r3, #2
	ldr r1, _080167A8 @ =_080167AC
	adds r0, r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080167A4: .4byte gUnknown_03006050
_080167A8: .4byte _080167AC
_080167AC: @ jump table
	.4byte _080167D4 @ case 0
	.4byte _080167E0 @ case 1
	.4byte _080167F8 @ case 2
	.4byte _08016814 @ case 3
	.4byte _08016840 @ case 4
	.4byte _08016898 @ case 5
	.4byte _080168DA @ case 6
	.4byte _08016938 @ case 7
	.4byte _08016964 @ case 8
	.4byte _08016980 @ case 9
_080167D4:
	movs r0, #0
	mov r1, r8
	strh r0, [r1, #0xa]
...
_08016836:
	b _08016A86
	.align 2, 0
_08016838: .4byte gIORegisters
_0801683C: .4byte gMain
_08016840:
	ldr r0, _0801688C @ =gMain
	ldr r0, [r0]
	movs r1, #5
	bl __umodsi3
	cmp r0, #0
...
_0801686C:
	...
	b _08016C68
	.align 2, 0
_0801688C: .4byte gMain
_08016890: .4byte gIORegisters
_08016894: .4byte 0x0000FFBF
_08016898:
	mov r2, r8
	ldrh r0, [r2, #0xa]
	adds r1, r0, #1
...
_080168AA:
	...
	b _08016974
_080168DA:
	ldr r4, _08016930 @ =gUnknown_03006050+0x10
	adds r0, r4, #0
	bl sub_8015DBC
	movs r0, #0xc6
	lsls r0, r0, #1
...
_0801691A:
	...
	b _08016C6A
	.align 2, 0
_08016930: .4byte gUnknown_03006050+0x10
_08016934: .4byte gMain
_08016938:
	mov r2, r8
	ldrh r0, [r2, #0xa]
	adds r1, r0, #1
...
_08016996:
	...
	b _08016C6A
_080169A0:
	ldr r0, _080169B8 @ =gUnknown_03006050
	movs r4, #6
	ldrsh r3, [r0, r4]
	mov r8, r0
	cmp r3, #6
...
_080169AE:
	lsls r0, r3, #2
	ldr r1, _080169BC @ =_080169C0
	adds r0, r0, r1
	ldr r0, [r0]
	mov pc, r0
	.align 2, 0
_080169B8: .4byte gUnknown_03006050
_080169BC: .4byte _080169C0
_080169C0: @ jump table
	.4byte _080169DC @ case 0
	.4byte _08016A02 @ case 1
	.4byte _08016A44 @ case 2
	.4byte _08016A78 @ case 3
	.4byte _08016A94 @ case 4
	.4byte _08016AD0 @ case 5
	.4byte _08016B24 @ case 6
_080169DC:
	movs r0, #1
	movs r1, #0
	movs r2, #0
	...
	movs r0, #0xa6
	bl PlaySE
	ldr r1, _08016A40 @ =gUnknown_03006050
	ldrh r0, [r1, #6]
	adds r0, #1
	strh r0, [r1, #6]
_08016A02:
...
_08016A38:
	...
	b _08016C68
	.align 2, 0
_08016A40: .4byte gUnknown_03006050
_08016A44:
	movs r0, #3
	movs r1, #1
	movs r2, #8
	...
	movs r0, #0x37
	bl sub_801480C
	ldr r1, _08016A74 @ =gUnknown_03006050
	ldrh r0, [r1, #6]
	adds r0, #1
	b _08016C68
	.align 2, 0
_08016A74: .4byte gUnknown_03006050
_08016A78:
	ldr r0, _08016A90 @ =gMain
	adds r0, #0x7e
	ldrh r0, [r0]
	cmp r0, #0
	beq _08016A84
...
_08016AA4:
	...
	movs r0, #0xa7
	bl PlaySE
	ldr r1, _08016ACC @ =gUnknown_03006050
	ldrh r0, [r1, #6]
	adds r0, #1
	b _08016C68
	.align 2, 0
_08016ACC: .4byte gUnknown_03006050
_08016AD0:
	movs r0, #0x38
	bl sub_8013EB0
	adds r4, r0, #0
...
_08016B0A:
	...
	adds r0, r5, #0
	bl DestroyAnimation
	ldr r1, _08016B20 @ =gUnknown_03006050
	ldrh r0, [r1, #6]
	adds r0, #1
	b _08016C68
	.align 2, 0
_08016B20: .4byte gUnknown_03006050
_08016B24:
	bl sub_8017C78
	adds r1, r0, #0
	cmp r1, #0
	...
	b _08016C6A
_08016B30:
	ldr r0, _08016B38 @ =gUnknown_03006050
	strh r1, [r0, #4]
	strh r1, [r0, #6]
	b _08016C6A
	.align 2, 0
_08016B38: .4byte gUnknown_03006050
_08016B3C:
	ldr r1, _08016BB0 @ =gUnknown_03006050
	movs r4, #6
	ldrsh r0, [r1, r4]
	cmp r0, #0
	beq _08016B48
...
_08016B6A:
	...
	bl sub_8010FA4
	bl m4aSoundVSyncOn
	ldr r0, _08016BB0 @ =gUnknown_03006050
	strh r4, [r0, #4]
	strh r4, [r0, #6]
	b _08016C6A
	.align 2, 0
_08016BB0: .4byte gUnknown_03006050
_08016BB4: .4byte gMain
_08016BB8:
	movs r6, #0
	ldr r1, _08016BFC @ =gUnknown_03006050
	movs r2, #0
	ldrsh r0, [r1, r2]
	cmp r6, r0
	bge _08016BE0
...
_08016BE0:
	...
	movs r0, #0
	strh r0, [r2]
	ldr r1, _08016C00 @ =0x040000D4
	str r2, [r1]
	ldr r0, _08016C04 @ =gBG0MapBuffer
	str r0, [r1, #4]
	ldr r0, _08016C08 @ =0x81000400
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	b _08016C62
	.align 2, 0
_08016BFC: .4byte gUnknown_03006050
_08016C00: .4byte 0x040000D4
_08016C04: .4byte gBG0MapBuffer
_08016C08: .4byte 0x81000400
_08016C0C:
	ldr r5, _08016C78 @ =gUnknown_03006050
	movs r2, #2
	ldrsh r4, [r5, r2]
	movs r3, #0
	ldrsh r0, [r5, r3]
...
_08016C32:
	...
	blt _08016C32
_08016C62:
	ldr r1, _08016C78 @ =gUnknown_03006050
	movs r0, #0
	strh r0, [r1, #4]
_08016C68:
	strh r0, [r1, #6]
_08016C6A:
	...
	bx r0
	.align 2, 0
_08016C78: .4byte gUnknown_03006050

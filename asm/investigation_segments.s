...
sub_800455C: @ 0x0800455C
	...
	mov r1, sp
	str r1, [r2]
	ldr r1, _08004594 @ =gExaminationData
	str r1, [r2, #4]
...
_08004594: .4byte gExaminationData
...
_080045F2:
	...
	str r0, [r1]
	ldr r0, _08004624 @ =gExaminationData
	str r0, [r1, #4]
...
_08004624: .4byte gExaminationData
...
_080046A8:
	...
	str r0, [r1]
	ldr r0, _080046C0 @ =gExaminationData
	str r0, [r1, #4]
...
_080046C0: .4byte gExaminationData
...
_080047DE:
	...
	str r0, [r1]
	ldr r0, _080047F4 @ =gExaminationData
	str r0, [r1, #4]
...
_080047F4: .4byte gExaminationData
...
_080048EA:
	...
	str r0, [r1]
	ldr r0, _08004900 @ =gExaminationData
	str r0, [r1, #4]
...
_08004900: .4byte gExaminationData
...
_08004908:
	...
	str r0, [r1]
	ldr r0, _08004958 @ =gExaminationData
	str r0, [r1, #4]
...
_08004958: .4byte gExaminationData
...
_080049D0:
	...
	str r0, [r1]
	ldr r0, _08004A08 @ =gExaminationData
	str r0, [r1, #4]
...
_08004A08: .4byte gExaminationData
...
_08004B10:
	...
	str r0, [r1]
	ldr r0, _08004B30 @ =gExaminationData
	str r0, [r1, #4]
...
_08004B30: .4byte gExaminationData
...
_08004B38:
	...
	str r0, [r1]
	ldr r0, _08004B88 @ =gExaminationData
	str r0, [r1, #4]
...
_08004B88: .4byte gExaminationData
...
_08004B90:
	...
	str r0, [r1]
	ldr r0, _08004BC4 @ =gExaminationData
	str r0, [r1, #4]
...
_08004BC4: .4byte gExaminationData
...
_08004BD0:
	...
	str r0, [r1]
	ldr r0, _08004C14 @ =gExaminationData
	str r0, [r1, #4]
...
_08004C14: .4byte gExaminationData
...
_08004C28:
	...
	str r0, [r1]
	ldr r0, _08004C5C @ =gExaminationData
	str r0, [r1, #4]
...
_08004C5C: .4byte gExaminationData
...
sub_8004C64: @ 0x08004C64
	...
	cmp r0, #0
	beq _08004C86
	ldr r0, _08004C8C @ =gExaminationData
	adds r0, #0x14
	movs r1, #0xff
	strh r1, [r0]
	adds r1, #3
...
_08004C86:
	...
	bx r0
	.align 2, 0
_08004C8C: .4byte gExaminationData
...
sub_8004CEC: @ 0x08004CEC
	...
	mov r1, sp
	str r1, [r2]
	ldr r3, _08004D24 @ =gExaminationData
	str r3, [r2, #4]
...
_08004D24: .4byte gExaminationData
...
_08005164:
	...
	str r0, [r1]
	ldr r0, _080051AC @ =gExaminationData
	str r0, [r1, #4]
...
_080051AC: .4byte gExaminationData
...
_080051C6:
	...
	str r0, [r1]
	ldr r0, _08005214 @ =gExaminationData
	str r0, [r1, #4]
...
_08005214: .4byte gExaminationData
...
_08005292:
	...
	str r0, [r1]
	ldr r0, _080052C0 @ =gExaminationData
	str r0, [r1, #4]
...
_080052C0: .4byte gExaminationData
...
_080052E4:
	str r0, [r1]
	ldr r0, _08005304 @ =gExaminationData
	str r0, [r1, #4]
...
_08005304: .4byte gExaminationData

...
Command15: @ 0x08008714
	...
	cmp r0, #0x15
	bne _08008736
	ldr r0, _08008748 @ =gAnimation+0x44
...
_0800873E:
	...
	bx r1
	.align 2, 0
_08008748: .4byte gAnimation+0x44
_0800874C: .4byte gMain

	thumb_func_start Command16
Command16: @ 0x08008750
	push {lr}
...
Command17: @ 0x08008798
	...
	adds r0, r4, #0
	adds r1, r6, #0
	bl FindEvidenceInCourtRecord
	adds r2, r0, #0
	cmp r2, #0
	bge _0800881E
	adds r0, r4, #0
	bl FindFirstEmptySlotInCourtRecord
	adds r2, r0, #0
	cmp r2, #0
	blt _0800881E
	cmp r4, #0
...
_08008876:
	...
	movs r2, #0xff
	strb r2, [r1]
	bl SortCourtRecordAndSyncListCount
_08008880:
	ldr r0, [r5, #4]
	adds r0, #2
	str r0, [r5, #4]
...
Command1A: @ 0x08008918
	...
	ldr r1, _08008968 @ =gCourtScrollGfxPointers
	lsls r0, r4, #2
	adds r0, r0, r1
	ldr r4, [r0]
	movs r0, #1
...
_0800894C:
	...
	bx r1
	.align 2, 0
_08008968: .4byte gCourtScrollGfxPointers

	thumb_func_start Command1B
Command1B: @ 0x0800896C
	push {r4, r5, lr}
	adds r3, r0, #0
	ldr r1, [r3, #4]
	adds r5, r1, #2
...
_08008A40:
	...
	movs r1, #0
	strb r1, [r0, #0x19]
	ldr r0, _08008A60 @ =gBG1MapBuffer
	movs r2, #0
	movs r1, #0xff
...
_08008A68:
	...
	cmp r0, #3
	bne _08008A82
	ldr r0, _08008A90 @ =gAnimation+0x44
	bl DestroyAnimation
...
_08008A90: .4byte gAnimation+0x44
...
_08008A98:
	...
	cmp r0, #3
	bne _08008AB2
	ldr r0, _08008AF8 @ =gAnimation+0x44
	bl DestroyAnimation
...
_08008AF8: .4byte gAnimation+0x44
...
_08008C84:
	ldr r0, _08008CA0 @ =gAnimation+0x44
	bl DestroyAnimation
...
Command1F: @ 0x08008CA8
	...
	orrs r0, r1
	strh r0, [r4]
	ldr r1, _08008D00 @ =gBG2MapBuffer
	movs r0, #0
...
Command20: @ 0x08008D0C
	...
	thumb_func_start Command21
Command21: @ 0x08008D1C
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, [r4, #4]
	adds r0, #2
